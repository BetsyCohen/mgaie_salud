---
title: "Clase 2 Procesamiento de proyecciones de población por departamentos de Argentina 2010-2025 (INDEC)"
author: "MGAIE"
date: "`r Sys.Date()`"
...
## Objetivo
El objetivo de este documento es presentar una forma programática de procesamiento de las proyecciones de poblacion por departamento 2010-2025 publicadas por el INDEC, usando el software estadístico R (R Core Team 2019) con sus librerías dplyr (Wickham et al. 2023), glue (Hester and Bryan 2022), foreign (R Core Team 2022) y stringr (Wickham 2022c), webdriver (Hidayat et al. 2021), rvest (Wickham 2022a), tidyverse (Wickham 2022b), DT (Xie, Cheng, and Tan 2023), highcharter (Kunst 2022).
