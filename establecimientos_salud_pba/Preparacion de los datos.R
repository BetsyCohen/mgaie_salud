...
mapa_partidos_pba <- read_sf("G:/Mi unidad/MGAIE/18.Visualizacion salud/mgaie_salud/establecimiemtos_salud_pba/fuentes/departamento/departamento.shp") 
# tabla trabajada previamente fuente INDEC
poblacion <- read.csv("G:/Mi unidad/MGAIE/18.Visualizacion salud/mgaie_salud/establecimiemtos_salud_pba/fuentes/proy_1025_depto_buenos_aires.csv",sep = ";", encoding = "latin1")
